      ...
      <div className="control-section">
        <div style={{ width: "100%" }}>
          <div style={{display:'none'}}>
            ...
            <div>
              {/* <FontPicker/> */}
              <DropDownPicker setValue={setFontFamily} value={fontFamily}/>
            </div>
            <div className="color-picker-div">
              {/* {color, hidden, setColor, setHidden} */}
              <ColorPicker
                color={colorShape}
                setColor={setColorShape}
                hidden={hiddenColorShape}
                setHidden={setHiddenColorShape}
                hiddenTitle={"Pick Shape Color"}
                openTitle={"Close Pick Shape Color"} 
              />
              <ColorPicker
                color={colorFont}
                ...
                hiddenTitle={"Pick Shape's Font Color"}
                openTitle={"Close Pick Shape's Font Color"} 
              />
            </div>
          ...
          >
            ...
            selectionChange={(args:ISelectionChangeEventArgs) => {
              if (args.state === 'Changed') { // NodeModel
                ...
                if (selectedItems?.length && selectedItems[0]?.properties?.annotations[0]) selectedItems[0].properties.annotations[0].properties.style.properties.fontFamily = fontFamily;
                ...
                if (!(selectedItems?.length && hiddenColorShape))
